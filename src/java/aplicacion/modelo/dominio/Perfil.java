...
public class Perfil  implements java.io.Serializable {
    ...
    public Perfil (Usuario usuarios, String perNombres, String perApellidos, String perDni, Date perFechaNac, String perEmail, String perDireccion, boolean perEstado, Set ventasEntradases) {
       this.usuarios = usuarios;
       this.perNombres = perNombres;
       this.perApellidos = perApellidos;
       this.perDni = perDni;
